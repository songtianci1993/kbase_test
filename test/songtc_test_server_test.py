...
from songtc_test.songtc_testServer import MethodContext


class songtc_testTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for nameval in config.items('songtc_test'):
            cls.cfg[nameval[0]] = nameval[1]
        cls.wsURL = cls.cfg['workspace-url']
        cls.wsClient = workspaceService(cls.wsURL, token=token)
        cls.serviceImpl = songtc_test(cls.cfg)
    ...
    def getWsName(self):
        ...
        wsName = "test_songtc_test_" + str(suffix)
